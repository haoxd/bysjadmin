...
<h5 style="color: orange;">${delsuccess }</h5>	
	...
	<tr onmouseout="this.style.background='white'" onmouseover="this.style.background='Aquamarine'">
	 ...
	 <a href=" http://localhost:8080/BYSJadmin/admin/deleateUserMessageByUmid?umid=${MessgaeInfos.userMessageBackId } " style="color: orange; text-decoration:none;"
      	...
      	<c:otherwise>
      		<a href="/BYSJadmin/admin/queryUserMessageBackInfocha?pageNo=1">首页</a>&nbsp;
      		<a href="/BYSJadmin/admin/queryUserMessageBackInfocha?pageNo=${pb.pageNo-1}">上一页</a>&nbsp;
      	</c:otherwise>
      </c:choose>
    	...
    	<c:choose>
    		...
    		<c:otherwise>
    			<a href="/BYSJadmin/admin/queryUserMessageBackInfocha?pageNo=${pb.pageNo+1}">下一页</a>&nbsp;
    			<a href="/BYSJadmin/admin/queryUserMessageBackInfocha?pageNo=${pb.totalPage}">尾页</a>&nbsp;
    		</c:otherwise>
    	</c:choose>
