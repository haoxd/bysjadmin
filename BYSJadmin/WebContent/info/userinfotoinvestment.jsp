...
<center>
<h4>投资${investmentName }全部用户信息如下：</h4>
	...
	<tr onmouseout="this.style.background='white'" onmouseover="this.style.background='Aquamarine'">
	  ...
	  <td><a style="color: orange; text-decoration:none;" href="http://${userinfo.userEmil}/" target="_blank">${userinfo.userEmil}</a></td>
      	...
      	<c:otherwise>
      		<a href="/BYSJadmin/admin/queryUserInfosToInvestment?pageNo=1&&investmentName=${investmentName }">首页</a>&nbsp;
      		<a href="/BYSJadmin/admin/queryUserInfosToInvestment?pageNo=${pb.pageNo-1}&&investmentName=${investmentName }">上一页</a>&nbsp;
      	</c:otherwise>
      </c:choose>
    	...
    	<c:choose>
    		...
    		<c:otherwise>
    			<a href="/BYSJadmin/admin/queryUserInfosToInvestment?pageNo=${pb.pageNo+1}&&investmentName=${investmentName }">下一页</a>&nbsp;
    			<a href="/BYSJadmin/admin/queryUserInfosToInvestment?pageNo=${pb.totalPage}&&investmentName=${investmentName }">尾页</a>&nbsp;
    		</c:otherwise>
    	</c:choose>
