 ...
 <div class="boxcenter" style="overflow:visible;">
    <div class="yxj_zhuce" style="overflow:visible;">
       ...
       <div class="yxj_zc_con" style="overflow:visible;height: 450px;">
        ...
        <form  action="/BYSJadmin/admin/addInvestment" method="post" class="yxj_zx02" style="overflow:visible; height:400px;" onsubmit="return expertSent()">
           
             <div class="yxj_zx02L" style="overflow:visible;">
             	 
             	
                 <h1><p>投资信息名称</p><span> 3大于字数小于8</span></h1>
                  <input type="text" id="investmentName" name="investmentName" placeholder=" 例如：平安理财">
                  <h1><p>周收益</p><span>周收益</span></h1>
                  <input type="text" id="weekEarnings" name="weekEarnings" placeholder="例如：0.5%">
                  <h1><p>月收益</p><span>月收益</span></h1>
                  <input type="text" id="monthEarnings" name="monthEarnings" placeholder="例如：1.2%">
                  <h1><p>年收益</p><span>年收益</span></h1>
                  <input type="text" id="yearEarnings" name="yearEarnings" placeholder="例如：12%">
             ...
             <div class="yxj_zx02R" style="overflow:visible;">
                <h1><p>类型</p><span>投资的类型</span></h1>
                  <input type="text" id="investmentState" name="investmentState" placeholder="例如：基金/股票/债券">
                  
				<h1><p>具体投资内容</p><span>账单详情</span></h1>
				<textarea rows="5" cols="19" id="investmentBody" name="investmentBody"  style="resize: none; height:200px; width:320px; font-family:'黑体'; "  ></textarea>		
