...
<p style="text-align:left; width:700px; margin:0 auto;">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	导出：<font color="red"><a href="http://localhost:8080/BYSJadmin/admin/downloaduserMessage">文档</a></font>
	</p>
	...
	<tr onmouseout="this.style.background='white'" onmouseover="this.style.background='Aquamarine'">
	   ...
	   <td >			
	      <c:choose>
		  <c:when test="${'差评' eq MessgaeInfos.userMessageIdear }">

			<ul >
				<li  ><p align="center"><font color="red" > ${MessgaeInfos.userMessageIdear }</font></p></li>
			</ul>
		 </c:when>
		 <c:when test="${'一般' eq MessgaeInfos.userMessageIdear}">
			<ul>
			<li  ><p align="center"><font color="blue">${MessgaeInfos.userMessageIdear}</font></p></li>							
			</ul>
		</c:when>
	 ...
	 <a href=" http://localhost:8080/BYSJadmin/admin/deleateUserMessageByUmid?umid=${MessgaeInfos.userMessageBackId } " style="color: orange; text-decoration:none;"
      	...
      	<c:otherwise>
      		<a href="/BYSJadmin/admin/queryUserMessageBackInfo?pageNo=1">首页</a>&nbsp;
      		<a href="/BYSJadmin/admin/queryUserMessageBackInfo?pageNo=${pb.pageNo-1}">上一页</a>&nbsp;
      	</c:otherwise>
      </c:choose>
    	...
    	<c:choose>
    		...
    		<c:otherwise>
    			<a href="/BYSJadmin/admin/queryUserMessageBackInfo?pageNo=${pb.pageNo+1}">下一页</a>&nbsp;
    			<a href="/BYSJadmin/admin/queryUserMessageBackInfo?pageNo=${pb.totalPage}">尾页</a>&nbsp;
    		</c:otherwise>
    	</c:choose>
